...
export function SignUpButton() {
  return (
    <a className="group p-1 shadow-signup-button bg-white flex w-full items-center" href={process.env.NEXT_PUBLIC_APPLICATION_URL} target="_blank" rel="noopener noreferrer">
      <div className="p-4">
